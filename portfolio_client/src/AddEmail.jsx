...
export function AddEmail({
    ...
    const handleEmailSubmit = (formData) => {
        postEmail("/api/emails", formData, allEmails, setAllEmails, setSendingEmail, setSentEmail)
    }

    return(
        sentEmail ?
        <div
            className="sent-email-container"
        >
            <h1>Email Sent!</h1>
        ...
        >
            <PostInput 
                ...
                register={register("emailSubject", { required: "Please enter the subject of the email" })}
            />
            ...
            <PostInput 
                ...
                additionalClassName="new-email-input"
                register={register("senderEmail", {required: "Please enter your email address"})}
            />
